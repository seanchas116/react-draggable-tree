...
var Tree = (function (_super) {
    ...
    function Tree() {
        ...
        this.onDrop = function (ev) {
            ...
            var srcInfos = _this.keysToInfos(Array.from(_this.props.selection.selectedKeys));
            var copy = ev.altKey || ev.ctrlKey;
            if (copy) {
    ...
    Tree.prototype.renderNode = function (node, path, visible) {
        var _this = this;
        var _a = this.propsWithDefaults(), indent = _a.indent, rowHeight = _a.rowHeight, rowContent = _a.rowContent, onSelectionChange = _a.onSelectionChange, onCollapsedChange = _a.onCollapsedChange, selection = _a.selection;
        var currentKey = selection.currentKey, selectedKeys = selection.selectedKeys;
        var key = node.key;
        ...
        var onClick = function (ev) {
            ...
            if (ev.ctrlKey || ev.metaKey) {
                ...
                var currentIndex = visibleKeys.indexOf(currentKey);
            ...
            onSelectionChange({
                selectedKeys: _this.removeAncestorsFromSelection(newSelected),
                currentKey: key
            });
        };
    ...
    Tree.prototype.canDrop = function (destInfo, destIndex) {
        var selectedKeys = this.props.selection.selectedKeys;
